import { IoSearchOutline, IoPersonOutline, IoHeartOutline, IoBagOutline, IoLogoInstagram, IoLogoFacebook, IoLogoPinterest, IoLogoYoutube, IoCheckmarkCircle, IoFlaskOutline, IoLeafOutline, IoShieldCheckmarkOutline, IoRibbonOutline, IoMedkitOutline, IoWaterOutline, IoSparklesOutline, IoDocumentTextOutline, IoTrendingUp, IoDownloadOutline, IoGlobeOutline, IoBeakerOutline, IoCameraOutline, IoChevronForward, IoBarChartOutline, IoNewspaperOutline } from "react-icons/io5";
import { HiOutlineSquares2X2 } from "react-icons/hi2";
export default function AdvancedFormulationsPage() {
  const innovationPillars = [
    ...
    { icon: HiOutlineSquares2X2, title: 'Clinical Research', stat: '20+ Years', desc: 'Evidence-based skincare backed by rigorous testing' },
  ...
  const publications = [
    {
      title: 'Advanced Peptide Delivery Systems in Anti-Aging',
      journal: 'Journal of Cosmetic Science',
      date: 'November 2024',
      findings: 'Novel encapsulation technology increases bioavailability by 340%'
    },
    {
      title: 'Marine-Derived Actives: Efficacy in Skin Barrier Repair',
      journal: 'International Journal of Dermatology',
      date: 'September 2024',
      findings: 'Deep-sea extracts demonstrate superior moisturization properties'
    },
    {
      title: 'Botanical Stem Cell Technology in Cosmetic Applications',
      journal: 'Skin Research & Technology',
      date: 'July 2024',
      findings: 'Plant stem cells show significant anti-aging benefits'
    }
  ];
  ...
  const faqItems = [
    {
      question: 'What makes Shan Loray formulations unique?',
      answer: 'Our formulations combine patented delivery systems with clinically-proven active ingredients at optimal concentrations. Every product undergoes rigorous testing and is backed by scientific research.'
    },
    {
      question: 'Are your products suitable for sensitive skin?',
      answer: 'Yes, all our products are dermatologist-tested and hypoallergenic. We use clean, non-irritating ingredients and avoid common sensitizers like synthetic fragrances and harsh alcohols.'
    },
    {
      question: 'How do you ensure ingredient purity and quality?',
      answer: 'We source ingredients from certified suppliers and conduct thorough testing including stability, safety, and efficacy assessments. Every batch is tested for purity and potency before release.'
    },
    {
      question: 'What is your approach to sustainable formulation?',
      answer: 'We prioritize natural-origin ingredients, sustainable sourcing practices, and eco-friendly production methods. Our formulations are 98% natural origin while maintaining clinical efficacy.'
    }
  ];
    ...
    <div className="bg-white font-['Cormorant_Garamond']">
      ...
      <div className="min-h-[560px] bg-gradient-to-b from-[#FDFBF7] to-[#F5F1EA] relative overflow-hidden flex items-center px-[120px]">
        <div className="w-[680px] relative z-10">
          ...
          <div className="w-[160px] h-[4px] bg-[#C9A870] shadow-[0_2px_8px_rgba(201,168,112,0.3)]" />
        </div>
      ...
      <div className="min-h-[320px] px-[120px] py-[80px] bg-white">
        ...
        <div className="grid grid-cols-4 gap-[24px]">
          {innovationPillars.map((pillar) => (
            <div key={pillar.title} className="bg-white rounded-[12px] border border-[#E8E3D9] shadow-[0_4px_16px_rgba(0,0,0,0.06)] p-[32px] flex flex-col items-center">
      ...
      {/* Signature Ingredients Showcase */}
      <div className="min-h-[720px] px-[120px] py-[80px] bg-[#FDFBF7]">
        ...
        <div className="grid grid-cols-4 gap-[24px]">
          {signatureIngredients.map((ingredient) => (
            <div key={ingredient.name} className="w-[282px] bg-white rounded-[12px] shadow-[0_8px_32px_rgba(0,0,0,0.08)] overflow-hidden">
              <img src={ingredient.image} alt={ingredient.name} className="w-[282px] h-[320px] object-cover" />
      ...
      {/* Formulation Technology Section */}
      ...
      <div className="min-h-[360px] relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center px-[120px]">
          <div className="grid grid-cols-4 gap-[48px] w-full">
            {[
              { stat: '20+', label: 'Years of Research' },
              { stat: '45+', label: 'Patents Awarded' },
              { stat: '150+', label: 'Scientific Publications' },
              { stat: '30+', label: 'Research Partnerships' }
            ].map((item) => (
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={source.region} className="flex items-center gap-4 bg-white rounded-[8px] border border-[#E8E3D9] p-[20px]">
                  <source.icon className="w-[24px] h-[24px] text-[#8B7355]" />
                  <div>
          ...
          {publications.map((pub) => (
            <div key={pub.title} className="bg-[#FDFBF7] rounded-[12px] border border-[#E8E3D9] p-[28px]">
              <div className="flex items-start justify-between">
                ...
                <button className="flex items-center gap-2 px-5 h-[44px] bg-[#8B7355] text-white text-[14px] font-medium rounded-[8px] ml-6">
            ...
            <div key={expert.name} className="bg-white rounded-[12px] shadow-[0_8px_32px_rgba(0,0,0,0.08)] p-[32px]">
              <div className="flex justify-center mb-5">
                <img 
                  src={expert.image}
                  alt={expert.name}
                  className="w-[160px] h-[160px] object-cover rounded-full border-4 border-[#C9A870]"
                />
              </div>
              ...
              <div className="relative">
                <IoNewspaperOutline className="w-[24px] h-[24px] text-[#C9A870] absolute -left-8 top-0" />
      ...
      <div className="min-h-[640px] px-[120px] py-[80px] bg-white">
        ...
        <div className="grid grid-cols-3 gap-[32px]">
          {heroProducts.map((product) => (
            <div key={product.name} className="bg-white rounded-[12px] border border-[#E8E3D9] shadow-[0_8px_32px_rgba(0,0,0,0.08)] overflow-hidden">
              ...
              <div className="p-[28px]">
                ...
                <button className="w-full h-[48px] bg-[#8B7355] text-white text-[14px] font-medium rounded-[8px] flex items-center justify-center gap-2">
                  Learn More
                  <IoChevronForward className="w-[18px] h-[18px]" />
                </button>
              </div>
            </div>
          ))}
      ...
      <div className="min-h-[360px] px-[120px] py-[80px] bg-[#FDFBF7]">
        ...
        <div className="grid grid-cols-4 gap-[24px]">
          {[
            ...
            <div key={test.title} className="bg-white rounded-[12px] border border-[#E8E3D9] p-[28px]">
      ...
      {/* Related Technology Pages CTA */}
      <div className="min-h-[480px] px-[120px] py-[80px] bg-white">
        <h2 className="text-[40px] font-medium text-[#1A1A1A] text-center mb-[56px]">Explore More Technology</h2>

        <div className="grid grid-cols-3 gap-[32px]">
          {relatedPages.map((page) => (
            <div key={page.title} className="bg-white rounded-[12px] shadow-[0_8px_32px_rgba(0,0,0,0.08)] overflow-hidden cursor-pointer">
