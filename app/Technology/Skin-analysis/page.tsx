...
export default function SkinAnalysisPage() {
  ...
  const specificConcerns = [
    'Fine Lines', 'Wrinkles', 'Large Pores', 'Dark Circles',
    'Uneven Tone', 'Hyperpigmentation', 'Redness', 'Blemishes',
    'Texture', 'Dullness', 'Firmness', 'Hydration'
  ];
    ...
    <div className="bg-white font-['Cormorant_Garamond']">
      ...
      <div className="min-h-[520px] bg-gradient-to-b from-[#FDFBF7] to-[#F5F1EA] relative overflow-hidden flex items-center px-[120px]">
        <div className="w-[650px] relative z-10">
          ...
          <h1 className="text-[80px] font-bold text-[#1A1A1A] leading-[1] mb-6">Discover Your Skin's True Potential</h1>
          <p className="text-[20px] font-normal text-[#666666] mb-8">Advanced AI technology analyzes your skin in 60 seconds with medical-grade precision for personalized beauty recommendations</p>
      ...
      <div className="min-h-[600px] px-[120px] py-[64px]">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="w-[800px] mx-auto bg-white rounded-[12px] shadow-[0_8px_32px_rgba(0,0,0,0.08)]">
            <div className="min-h-[400px] bg-gradient-to-b from-[#F5F1EA] to-white border-2 border-dashed border-[#C9A870] rounded-t-[12px] flex flex-col items-center justify-center">
              ...
              <div className="flex gap-3">
                <button className="w-[180px] h-[56px] bg-[#8B7355] text-white text-[15px] font-medium rounded-[8px]">
                  Upload Photo
                </button>
                <button className="w-[180px] h-[56px] bg-white border-2 border-[#8B7355] text-[#8B7355] text-[15px] font-medium rounded-[8px]">
                  Take Selfie
                </button>
              </div>
            </div>
          ...
          <div className="w-[800px] mx-auto mt-8 min-h-[100px] bg-[#F5F1EA] rounded-[12px] flex flex-col items-center justify-center py-6 px-6">
      ...
      <div className="min-h-[700px] bg-[#FDFBF7] px-[120px] py-[64px]">
        ...
        <div className="max-w-[1200px] mx-auto grid grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white rounded-[16px] shadow-[0_4px_16px_rgba(0,0,0,0.06)] p-[32px]">
            ...
            <div className="grid grid-cols-2 gap-3">
              {skinConcerns.map((concern, idx) => (
                <button 
                  key={concern}
                  className={`h-[48px] px-4 ${idx === 0 ? 'bg-[#8B7355] text-white' : 'bg-[#F5F1EA] text-[#3D3D3D]'} text-[14px] font-normal rounded-[8px]`}
                >
                  {concern}
                </button>
              ))}
          ...
          <div className="bg-white rounded-[16px] shadow-[0_4px_16px_rgba(0,0,0,0.06)] p-[32px]">
            ...
            <div className="grid grid-cols-3 gap-3">
              {skinTypes.map((type, idx) => (
                <button 
                  key={type}
                  className={`h-[48px] px-4 ${idx === 2 ? 'bg-[#8B7355] text-white' : 'bg-[#F5F1EA] text-[#3D3D3D]'} text-[14px] font-normal rounded-[8px]`}
                >
                  {type}
                </button>
              ))}
          ...
          <div className="bg-white rounded-[16px] shadow-[0_4px_16px_rgba(0,0,0,0.06)] p-[32px]">
            ...
            <div className="relative w-full h-[56px] bg-white border border-[#E8E3D9] rounded-[8px] flex items-center justify-between px-5 cursor-pointer">
          ...
          <div className="bg-white rounded-[16px] shadow-[0_4px_16px_rgba(0,0,0,0.06)] p-[32px]">
            ...
            <div className="pt-4">
              <div className="relative w-full h-[8px] bg-[#E8E3D9] rounded-full mb-4">
                ...
                <div className="absolute left-[60%] top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[20px] h-[20px] bg-[#8B7355] rounded-full border-4 border-white shadow-md" />
              </div>
          ...
          <div className="bg-white rounded-[16px] shadow-[0_4px_16px_rgba(0,0,0,0.06)] p-[32px]">
            ...
            <div className="grid grid-cols-3 gap-3">
              {ageRanges.map((range, idx) => (
                <button 
                  key={range}
                  className={`h-[48px] px-4 ${idx === 1 ? 'bg-[#8B7355] text-white' : 'bg-[#F5F1EA] text-[#3D3D3D]'} text-[14px] font-normal rounded-[8px]`}
                >
                  {range}
                </button>
              ))}
            ...
            <div className="grid grid-cols-4 gap-3">
              {specificConcerns.map((concern, idx) => (
                <label key={concern} className="flex items-center gap-3 cursor-pointer">
                  <div className={`w-[18px] h-[18px] border-2 rounded-[2px] flex items-center justify-center ${[0, 4, 8].includes(idx) ? 'border-[#8B7355] bg-[#8B7355]' : 'border-[#C9A870]'}`}>
                    {[0, 4, 8].includes(idx) && (
                      <IoCheckmarkCircle className="w-[14px] h-[14px] text-white" />
                    )}
                  </div>
        ...
        <div className="flex justify-center">
          <button className="w-[240px] h-[56px] bg-[#8B7355] text-white text-[16px] font-medium rounded-[8px]">
            Analyze My Skin
          </button>
        </div>
      </div>
      ...
      <div className="min-h-[900px] bg-white px-[120px] py-[80px]">
        ...
        {/* Overview Dashboard */}
        <div className="max-w-[1200px] mx-auto min-h-[320px] bg-gradient-to-b from-[#F5F1EA] to-white rounded-[16px] p-[40px] mb-10">
      ...
      <div className="min-h-[800px] bg-[#FDFBF7] px-[120px] py-[80px]">
        ...
        <div className="max-w-[1200px] mx-auto bg-white rounded-[16px] shadow-[0_4px_16px_rgba(0,0,0,0.06)] p-[40px] mb-8">
          <div className="mb-6">
            <span className="inline-block px-4 py-2 bg-[#F5F1EA] text-[#8B7355] text-[12px] font-medium rounded-full mb-4">
              STEP 1: MORNING
            </span>
          ...
          <div className="grid grid-cols-4 gap-5">
            {morningProducts.map((product) => (
              <div key={product.name} className="bg-white rounded-[8px] overflow-hidden border border-[#E8E3D9]">
      ...
      <div className="min-h-[400px] bg-white px-[120px] py-[64px]">
        ...
        <div className="max-w-[1200px] mx-auto min-h-[240px] bg-gradient-to-b from-[#F5F1EA] to-white rounded-[16px] p-[40px]">
          <div className="flex items-center justify-between mb-8">
            ...
            <button className="w-[180px] h-[48px] bg-[#8B7355] text-white text-[15px] font-medium rounded-[8px]">
