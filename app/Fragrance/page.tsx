...
export default function ShanLorayFragrancePage() {
  ...
  const horizontalProducts = [
    {
      ...
      rating: 5,
      reviews: 534,
      image: 'https://images.unsplash.com/photo-1541643600914-78b084683601?w=460&h=280&fit=crop',
      notes: 'Rose, Amber, Patchouli',
      concentration: 'EDP',
    ...
    },
    {
      ...
      rating: 5,
      reviews: 298,
      image: 'https://images.unsplash.com/photo-1594035910387-fea47794261f?w=460&h=280&fit=crop',
  ...
  const squareProducts = [
    ...
    },
    {
      ...
      rating: 5,
      reviews: 789,
      image: 'https://images.unsplash.com/photo-1587556930796-7a8ab4e96a17?w=300&h=300&fit=crop',
      concentration: 'EDT'
    }
  ];
  ...
  const rectangularProducts = [
    {
      ...
      description: 'Experience our six most iconic fragrances in luxurious travel sizes - perfect for exploring your signature scent',
      price: '$295',
      rating: 5,
      reviews: 203,
      image: 'https://images.unsplash.com/photo-1615634260167-c8cdede054de?w=470&h=400&fit=crop',
      badge: 'LIMITED EDITION'
    },
    {
      name: 'Dual Essence Set',
      description: 'Day and night fragrances paired perfectly - fresh citrus for morning, warm amber for evening',
      price: '$385',
      rating: 5,
      reviews: 167,
      image: 'https://images.unsplash.com/photo-1563170351-be82bc888aa4?w=470&h=400&fit=crop'
    }
  ];
                  ...
                  {idx === 1 && (
                    <div className="ml-[24px] mt-[8px] space-y-[6px]">
                      {["Women's EDP", "Men's EDP", 'Unisex EDP'].map((subcat) => (
                        <div key={subcat} className="inline-block px-[16px] py-[6px] bg-white border border-[#E8E3D9] text-[#666666] text-[13px] font-normal rounded-full cursor-pointer mr-2 mb-2">
                          {subcat}
                        </div>
                      ))}
                    </div>
            ...
            <div className="w-[460px] h-[560px] bg-white rounded-[12px] overflow-hidden shadow-[0_4px_16px_rgba(0,0,0,0.08)] group cursor-pointer">
              ...
              <div className="p-[24px]">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="px-[12px] py-[4px] bg-[#F5F1EA] text-[#8B7355] text-[11px] font-medium rounded-full">
                  ...
                  <div className="flex-1 p-[24px] flex flex-col justify-center">
                    ...
                    <div className="flex items-center gap-[8px] mb-3">
                      {product.sizes.map((size) => (
                        <span key={size} className="px-[12px] py-[4px] border border-[#E8E3D9] text-[#666666] text-[12px] font-normal rounded-full">
                          {size}
                        </span>
                      ))}
                    </div>
