...
export default function ShanLorayCollectionsPage() {
  ...
  const featuredProducts = [
    {
      name: 'Ultimate Renewal Collection',
      description: 'Complete anti-aging ritual with our most potent actives',
      price: '$485',
      rating: 5,
      reviews: 324,
      image: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=460&h=560&fit=crop'
    },
    {
      name: 'Hydration Essentials Trio',
      description: 'Three-step moisture boost for plump, dewy skin',
      price: '$285',
      rating: 5,
      reviews: 412,
      image: 'https://images.unsplash.com/photo-1556228720-195a672e8a03?w=460&h=280&fit=crop'
    },
    {
      name: 'Brightening Ritual Set',
      description: 'Vitamin C powered routine for luminous glow',
      price: '$345',
      rating: 5,
      reviews: 287,
      image: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=460&h=280&fit=crop'
    }
  ];
  ...
  const squareProducts = [
    {
      ...
      description: 'Perfect starter collection',
      price: '$165',
      rating: 5,
      reviews: 589,
    ...
    },
    {
      ...
      description: 'Night repair essentials',
      price: '$245',
      rating: 5,
      reviews: 356,
  ...
  const rectangularProducts = [
    {
      name: 'Complete Skincare Journey',
      description: 'Six essential steps to transformative skin - cleanser, toner, serum, moisturizer, eye cream, and SPF',
      price: '$595',
      rating: 5,
      reviews: 203,
      image: 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=470&h=400&fit=crop'
    },
    {
      name: 'Deluxe Discovery Collection',
      description: 'Experience our bestsellers in generous deluxe sizes perfect for gifting or trying',
      price: '$385',
      rating: 5,
      reviews: 167,
      image: 'https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?w=470&h=400&fit=crop'
    }
  ];
        ...
        <div className="mb-[48px]">
          ...
          <div className="flex items-center justify-center gap-[12px] flex-wrap">
            {categories.map((cat, idx) => (
              <div 
                key={cat} 
                className={`px-[20px] py-[10px] rounded-full cursor-pointer ${idx === 0 ? 'bg-[#8B7355] text-white' : 'bg-[#F5F1EA] text-[#3D3D3D]'}`}
              >
