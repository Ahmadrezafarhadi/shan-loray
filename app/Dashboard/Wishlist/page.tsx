  ...
  const wishlistProducts = [
    {
      ...
      image: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?w=560&h=560&fit=crop',
      rating: 4.9,
      reviews: 342,
      originalPrice: 380,
      currentPrice: 342,
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1617897903246-719242758050?w=560&h=560&fit=crop',
      rating: 4.8,
      reviews: 567,
      originalPrice: 135,
      currentPrice: 115,
    ...
    },
    {
      id: 3,
      brand: 'DIOR',
      name: 'Prestige La Micro-Huile de Rose',
      image: 'https://images.unsplash.com/photo-1571875257727-256c39da42af?w=560&h=560&fit=crop',
      rating: 4.7,
      reviews: 289,
      originalPrice: 425,
      currentPrice: 425,
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1541643600914-78b084683601?w=560&h=560&fit=crop',
      rating: 4.9,
      reviews: 834,
      originalPrice: 295,
      currentPrice: 265,
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1556228841-a6d4522f2c88?w=560&h=560&fit=crop',
      rating: 4.6,
      reviews: 456,
      originalPrice: 100,
      currentPrice: 85,
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?w=560&h=560&fit=crop',
      rating: 4.8,
      reviews: 721,
      originalPrice: 68,
      currentPrice: 68,
      ...
      <div className="min-h-[600px] px-[120px] py-[48px]">
        <div className="max-w-[1200px] mx-auto flex gap-[40px]">
          ...
          <div className="flex-1 w-[840px]">
            {/* Action Bar */}
            <div className="min-h-[64px] bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-[24px] flex items-center justify-between mb-[24px]">
              ...
              <div className="flex items-center gap-[12px]">
                <button className="h-[40px] px-[20px] bg-white border-[1.5px] border-[#E8E3D9] text-[#666666] text-[14px] font-medium rounded-[8px] cursor-pointer flex items-center gap-[8px]">
            ...
            <div className="grid grid-cols-2 gap-[24px] mb-[24px]">
              {wishlistProducts.map((product) => (
                <div key={product.id} className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-[20px] min-h-[360px]">
                  {/* Product Image */}
                  <div className="relative w-full h-[280px] rounded-[8px] overflow-hidden mb-[16px]">
                    <img
                      src={product.image}
                      alt={product.name}
                      className="w-full h-full object-cover"
                    />
                    <div className="absolute top-[12px] right-[12px] w-[36px] h-[36px] rounded-full bg-white shadow-[0_2px_8px_rgba(0,0,0,0.15)] flex items-center justify-center cursor-pointer">
                  ...
                  <div className="mb-[16px]">
                    ...
                    <h3 className="text-[18px] font-semibold text-[#1A1A1A] mb-[8px] line-clamp-2">{product.name}</h3>
                    ...
                    {/* Stock Status */}
                    <div className={`inline-block px-[12px] py-[4px] rounded-[4px] text-[12px] font-medium ${
                      product.stock === 'In Stock' ? 'bg-[#F0F8F0] text-[#7BA85D]' : 'bg-[#FFF4E6] text-[#E5A84D]'
                    }`}>
                      {product.stock}
                    </div>
                  </div>
                  ...
                  <div className="space-y-[12px]">
                    <button className="w-full h-[48px] bg-[#8B7355] text-white text-[16px] font-medium rounded-[8px] cursor-pointer">
                      Add to Cart
                    </button>
                    <button className="w-full text-[14px] font-medium text-[#C84848] underline cursor-pointer">
                      Remove
                    </button>
                  </div>
                </div>
            ...
            <div className="bg-[#F5F1EA] rounded-[12px] p-[24px] flex items-center justify-between mb-[24px]">
              <button className="text-[14px] font-medium text-[#C84848] underline cursor-pointer">
                Clear All Items
              </button>
              <button className="h-[48px] px-[32px] bg-white border-[1.5px] border-[#E8E3D9] text-[#666666] text-[15px] font-medium rounded-[8px] cursor-pointer">
                Continue Shopping
              </button>
            </div>

            {/* Share Wishlist Modal (Static Representation) */}
            <div className="bg-white rounded-[16px] shadow-[0_8px_32px_rgba(0,0,0,0.12)] p-[32px] w-[520px] mx-auto">
              <div className="flex items-center justify-between mb-[24px]">
                <h2 className="text-[24px] font-semibold text-[#1A1A1A]">Share Your Wishlist</h2>
                <IoCloseOutline className="w-[24px] h-[24px] text-[#666666] cursor-pointer" />
              </div>
              ...
              <div className="bg-[#F5F1EA] rounded-[8px] p-[16px] flex items-center justify-between mb-[24px]">
                ...
                <button className="flex items-center gap-[8px] text-[14px] font-medium text-[#8B7355] cursor-pointer">
              ...
              <div className="flex items-center justify-center gap-[16px]">
                <div className="w-[56px] h-[56px] rounded-full bg-[#FDFBF7] border-[1.5px] border-[#E8E3D9] flex items-center justify-center cursor-pointer">
                  <IoLogoInstagram className="w-[28px] h-[28px] text-[#8B7355]" />
                </div>
                <div className="w-[56px] h-[56px] rounded-full bg-[#FDFBF7] border-[1.5px] border-[#E8E3D9] flex items-center justify-center cursor-pointer">
                  <IoLogoWhatsapp className="w-[28px] h-[28px] text-[#8B7355]" />
                </div>
                <div className="w-[56px] h-[56px] rounded-full bg-[#FDFBF7] border-[1.5px] border-[#E8E3D9] flex items-center justify-center cursor-pointer">
                  <IoMail className="w-[28px] h-[28px] text-[#8B7355]" />
                </div>
              </div>
            </div>
          </div>
