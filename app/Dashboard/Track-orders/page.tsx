    ...
    <div className="bg-white font-['Cormorant_Garamond']">
      ...
      <div className="min-h-[200px] bg-gradient-to-b from-[#FDFBF7] to-white flex flex-col items-center justify-center px-[120px]">
        <div className="max-w-[1200px] w-full">
          ...
          <p className="text-[18px] font-normal text-[#666666] mt-[8px]">Enter your order number to view real-time tracking information</p>
        </div>
      </div>
        ...
        <div className="max-w-[1200px] mx-auto flex gap-[40px]">
          ...
          <div className="flex-1 w-[840px]">
              ...
              <div className="flex items-center justify-between mb-[48px]">
                {[
                  ...
                  <div key={stage.label} className="flex items-center flex-1">
                    ...
                    {index < 3 && (
                      <div className={`flex-1 h-[2px] mx-[16px] mb-[48px] ${
                ...
                <div>
                  <div className="mb-[20px]">
                    ...
                    <div className="flex items-center gap-[8px]">
                      ...
                      <IoCopyOutline className="w-[18px] h-[18px] text-[#8B7355] cursor-pointer" />
                    </div>
                  </div>
                  <div className="mb-[20px]">
                ...
                <div>
                  ...
                  <div>
                    ...
                    <div className="flex items-start gap-[8px]">
                      <IoLocationOutline className="w-[18px] h-[18px] text-[#8B7355] mt-[2px]" />
                      <div className="text-[15px] font-normal text-[#2B2B2B]">
                        Alexandra Chen<br />
              ...
              <div className="space-y-[24px]">
                {deliveryUpdates.map((update, index) => (
                  <div key={index} className="flex gap-[16px]">
                    <div className="flex flex-col items-center">
                      <div className="w-[32px] h-[32px] bg-white rounded-full flex items-center justify-center border-2 border-[#8B7355]">
            ...
            <div className="bg-gradient-to-br from-[#FDFBF7] to-[#F5F1EA] rounded-[12px] p-[32px] mb-[24px]">
              ...
              <div className="flex items-center gap-[16px]">
                <button className="flex-1 flex items-center justify-center gap-[8px] bg-[#8B7355] text-white text-[15px] font-medium h-[48px] rounded-[8px] cursor-pointer">
                  <IoChatbubbleEllipsesOutline className="w-[20px] h-[20px]" />
                  Contact Support
                </button>
                <button className="flex-1 flex items-center justify-center gap-[8px] bg-white border border-[#8B7355] text-[#8B7355] text-[15px] font-medium h-[48px] rounded-[8px] cursor-pointer">
            ...
            <div className="bg-white rounded-[12px] shadow-[0_4px_16px_rgba(0,0,0,0.08)] p-[32px]">
                ...
                {recentOrders.map((order) => (
                  <div key={order.orderNumber} className="flex items-center justify-between py-[16px] border-b border-[#F5F1EA]">
                    ...
                    <div className="flex items-center gap-[16px]">
                      ...
                      <button className="border border-[#8B7355] text-[#8B7355] text-[14px] font-medium px-[16px] py-[6px] rounded-[8px] cursor-pointer">
                        Track
                      </button>
                    </div>
                  </div>
              ...
              <button className="w-full text-[15px] font-medium text-[#8B7355] cursor-pointer flex items-center justify-center gap-[6px]">
                View All Orders
