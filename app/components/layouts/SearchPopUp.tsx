    ...
    <>
      ...
      <div className="fixed inset-0 z-[70] flex items-start justify-center overflow-y-auto">
        ...
        >
          ...
          <div className="min-h-[120px] bg-white flex items-center justify-between px-[120px] border-b border-[#E8E3D9] sticky top-0 z-10">
            <button
              onClick={onClose}
            ...
            <div className="relative">
              <IoSearchOutline className="absolute left-[24px] top-1/2 transform -translate-y-1/2 w-[24px] h-[24px] text-[#8B7355]" />
              <input
                ref={inputRef}
                type="text"
              ...
              />
              <IoCloseCircle className="absolute right-[24px] top-1/2 transform -translate-y-1/2 w-[20px] h-[20px] text-[#999999] cursor-pointer hover:text-[#666666] transition-colors" />
            </div>
          ...
          <div className="min-h-[80px] bg-gradient-to-b from-[#FDFBF7] to-white flex items-center justify-center">
            <div className="flex items-center gap-[16px]">
              {quickCategories.map((category, idx) => (
                <button
                  key={category}
                  className={`h-[44px] px-[24px] rounded-full text-[15px] transition-all cursor-pointer ${
                    idx === 0
              ...
              <div className="min-h-[400px] mb-[48px]">
                ...
                <div className="grid grid-cols-3 gap-[20px]">
                  {productSuggestions.map((product) => (
                    <div
                      key={product.name}
                      className="bg-white rounded-[8px] p-[16px] cursor-pointer hover:shadow-[0_4px_16px_rgba(0,0,0,0.1)] transition-shadow"
                    >
                      <img
                        src={product.image}
                        alt={product.name}
                        className="w-[160px] h-[160px] object-cover rounded-[8px] mb-[12px]"
                      />
